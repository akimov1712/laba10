...
namespace SortingAlgorithms
{
    public class Program
    {
        ...
        static void compareSelectionSort(int[] arr1)
        {
            ...
            using (StreamWriter writer = new StreamWriter(@"C:\Users\User\Desktop\laba10.1\sorted.dat"))
            {
        ...
        static void compareInsertionSort(int[] arr1)
        {
            ...
            using (StreamWriter writer = new StreamWriter(@"C:\Users\User\Desktop\laba10.1\sorted.dat", true))
            {
